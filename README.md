...
I want to start with making a exp/hour calculator that lives in the terminal to explore input and python's ability to read time or read the system's internal time.
- See Logbook.md for in logbook-stuff.
